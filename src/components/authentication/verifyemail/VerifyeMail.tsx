...
import Verification from "../../../../public/images/email-img.png";


const VerifyeMail = () => {
    return (
        <>
            <div className='sec-email p-50 bg-img position-relative'>
                <div className='container position-relative z-1'>
                    <div className='mx-540 text-center'>
                        <div className='text-start'>
                            <h2>Verify email</h2>

                        <p className='mb-40'>We’ve sent a confirmation link to your registered email: <b>da****ph@gmail.com</b>  Please check your inbox and click the link to verify your account.</p>

                        </div>
                        <div className='figure-box-img mb-40'>
                            <Image src={Verification} alt='' />
                        </div>
                        <p>
                            <Link href="" className='link-underline-text my-inbox'>
